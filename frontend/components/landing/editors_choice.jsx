...
const EditorsChoiceLanding = props => (
        ...
        <div className="editors-gallery-row">
          ...
          <div className="editors-gallery-col">
            <div className="editors-box">
              ...
              <div className="editors-img-attribution">
                <span className="img-attribution-link">
            ...
            <div className="editors-box">
              ...
              <div className="editors-img-attribution">
                <span to={'#'} className="img-attribution-link">
                  <span>Photo by Username</span>
                </span>
              </div>
            </div>
          ...
          <div className="editors-gallery-col">
            ...
            <div className="editors-box">
              ...
              <div className="editors-img-attribution">
                <div className="img-attribution-link">
                  <span>Photo by Username</span>
                </div>
              </div>
            </div>
...
export default EditorsChoiceLanding