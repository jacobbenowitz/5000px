...
class PopularPhotos extends React.Component {
  constructor(props){
    super(props);
    this.state = {
  ...
  render () {
    var images =
      ...
      return (
        <div className='span-12 popular-photos'>
    ...
    images: ([
        {
            ...
            thumbnailWidth: 271,
            thumbnailHeight: 320,
            tags: [{value: <a href={"/TEST"}>Potato</a>, title: 'bag of potatoes', key: '1213123'}],
